...
{!! HTML::script( URL::asset('js/admin/machine-availability.js') ) !!}
@stop
...
<script>
    ...
    jQuery(document).ready(function () {
        siteObjJs.admin.machineAvailabilityJs.init();
        siteObjJs.admin.commonJs.boxExpandBtnClick();
        siteObjJs.admin.machineAvailabilityJs.selectMachine = "{!! trans('admin::messages.select-name',['name'=>trans('admin::controller/machine-availability.machine')]) !!}";
    });
</script>
@stop
...
@include('admin::machine-availability.create')
@endif
...
<div class="portlet light col-lg-12">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-blue-sharp bold uppercase">{!! trans('admin::messages.view-name',['name'=>trans('admin::controller/machine-availability.machine-availability')]) !!}</span>
        </div>
        @if(!empty(Auth::guard('admin')->user()->hasAdd))
        <div class="actions">
            <a href="javascript:;" class="btn blue btn-add-big btn-expand-form"><i class="fa fa-plus"></i><span class="hidden-480">{!! trans('admin::messages.add-name',['name'=>trans('admin::controller/machine-availability.machine-availability')]) !!} </span></a>
        </div>
        @endif
    </div>
    <div class="portlet-body">
        <div class="table-container">
            ...
            <table class="table table-striped table-bordered table-hover" id="machine-availability-table">
                <thead>
                    <tr role="row" class="heading">
                        ...
                        <th width='19%'>Machine Name</th>
                        <th width='31%'>Availability Date</th>
                        <th width='9%'>Start Time</th>
                        <th width='9%'>End Time</th>
                        <!--<th width='15%'>{!! trans('admin::controller/machine-availability.break-time') !!}</th>
                        <th width='15%'>Carry Forward</th>
                        <th width='15%'>Carry Forward Days</th>-->
                        <th width='5%'>Status</th>
                        <th width='5%'>Action</th>
                    </tr>
                    @include('admin::machine-availability.search')
                </thead>
                <tbody>
