<tr role="row" class="filter">
    ...
    <td id="machine-drop-down-search">
        {!!  Form::select('machine_id', ['' => 'Select Machine'] +$machineList, null, ['id' => 'machines_dropdown', 'autocomplete' => 'off', 'class'=>'form-control form-filter input-sm width-auto select2me'])!!}
    </td>
<!--    <td>
