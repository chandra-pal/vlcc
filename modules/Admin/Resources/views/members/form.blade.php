<div class="form-body">
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
            {!! Form::text('calories', null, ['class'=>'form-control', 'id'=>'calories', 'data-rule-number' => '10', 'data-rule-required'=>'true', 'data-msg-number'=>'Please enter valid calories.', 'data-msg-required'=>trans('admin::messages.required-enter', ['name' => trans('admin::controller/food.calories')]) ]) !!}
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
            {!! Form::text('serving_size', null, ['class'=>'form-control', 'id'=>'serving_size', 'data-rule-number' => '10', 'data-rule-required'=>'true', 'data-msg-number'=>'Please enter valid serving size.', 'data-msg-required'=>trans('admin::messages.required-enter', ['name' => trans('admin::controller/food.serving-size')]) ]) !!}
