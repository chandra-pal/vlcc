<div class="portlet box yellow-gold edit-form-main">
    <div class="portlet-title togglelable">
        <div class="caption">
            <i class="fa fa-pencil"></i>{!! trans('admin::messages.edit-name', ['name' => trans('admin::controller/food.food') ]) !!}
        </div>
        <div class="tools">
    ...
    <div class="portlet-body form">
        {!! Form::model($food, ['route' => ['admin.food.update', $food->id], 'method' => 'put', 'class' => 'form-horizontal panel food-form','id'=>'edit-food', 'msg' => trans('admin::messages.updated',['name'=>trans('admin::controller/food.food')]) ]) !!}
