...
<div class="portlet light col-lg-12">
    <div class="portlet-title">
        <div class="caption">
            ...
            <input type="hidden" value="" id="newDate" name="newDate">
            <input type="hidden" value="" id="schedule_type" name="schedule_type">
            <input type="hidden" value="" id="diteticianId" name="diteticianId">
        </div>
    ...
    <div class="portlet-body">
        <div class="table-container">
            ...
            <table class="table table-striped table-bordered table-hover" id="deviation-list-table">
                <thead>
                    <tr role="row" class="heading">
                        <th width='1%'>#</th>
                        <th>{!! trans('admin::controller/deviation.deviation-id') !!}</th>
                        <th width='54%'>{!! trans('admin::controller/deviation.center-name') !!}</th>
