...
<div class="portlet light col-lg-12">
    <div class="portlet-title">
		...
		<div class="actions" style="margin-right: 35px; ">
			 <a href="{{route('admin.session-bookings.download-booking-history','from'.'='.$params['from'].'&'.'to'.'='.$params['to'].'&'.'customer'.'='.$params['member_id'] )}}" class = "btn blue btn-add-big" ><i class = "fa fa-download"></i><span class="hidden-480">Download Excel</span></a>
		</div>
