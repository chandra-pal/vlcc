<div class="portlet box yellow-gold edit-form-main">
    <div class="portlet-title togglelable">
        <div class="caption">
            <i class="fa fa-pencil"></i>{!! trans('admin::messages.edit-name', ['name' => trans('admin::controller/products.products') ]) !!}
        </div>
        <div class="tools">
    ...
    <div class="portlet-body form">
        {!! Form::model($products, ['route' => ['admin.products.update', $products->id], 'method' => 'put', 'class' => 'form-horizontal panel products-form','id'=>'edit-products', 'files' => 'true', 'msg' => trans('admin::messages.updated',['name'=>trans('admin::controller/products.products')]) ]) !!}
