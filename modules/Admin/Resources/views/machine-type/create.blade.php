<div class="portlet box blue add-form-main">
    <div class="portlet-title togglelable">
        <div class="caption">
            <i class="fa fa-plus"></i>Add New Machine Type
        </div>
        <div class="tools">
    ...
    <div class="portlet-body form display-hide">
        {!! Form::open(['route' => ['admin.machine-type.store'], 'method' => 'post', 'class' => 'form-horizontal post-form',  'id' => 'create-machine-type', 'msg' => 'Machine Type added successfully.']) !!}
