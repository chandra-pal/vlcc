<div class="portlet box blue add-form-main">
    <div class="portlet-title togglelable">
        <div class="caption">
            <i class="fa fa-plus"></i>Add New Beauty Service
        </div>
        <div class="tools">
    ...
    <div class="portlet-body form display-hide">
        {!! Form::open(['route' => ['admin.beauty-service.store'], 'method' => 'post', 'class' => 'form-horizontal post-form',  'id' => 'create-beauty-service', 'msg' => 'Beauty Service added successfully.']) !!}
