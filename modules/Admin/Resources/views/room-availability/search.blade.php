<tr role="row" class="filter">
    ...
    <td id="room-drop-down-search">
        {!!  Form::select('room_id', ['' => 'Select Room'] +$roomList, null, ['autocomplete' => 'off', 'class'=>'form-control form-filter input-sm width-auto select2me'])!!}
    </td>
<!--    <td>
