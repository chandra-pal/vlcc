...
{!! HTML::script( URL::asset('js/admin/room-availability.js') ) !!}
@stop
...
<script>
    ...
    jQuery(document).ready(function () {
        siteObjJs.admin.roomAvailabilityJs.init();
        siteObjJs.admin.commonJs.boxExpandBtnClick();
        siteObjJs.admin.roomAvailabilityJs.selectRoom = "{!! trans('admin::messages.select-name',['name'=>trans('admin::controller/room-availability.room')]) !!}";
    });
</script>
@stop
...
@include('admin::room-availability.create')
@endif
...
<div class="portlet light col-lg-12">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-blue-sharp bold uppercase">{!! trans('admin::messages.view-name',['name'=>trans('admin::controller/room-availability.room-availability')]) !!}</span>
        </div>
        @if(!empty(Auth::guard('admin')->user()->hasAdd))
        <div class="actions">
            <a href="javascript:;" class="btn blue btn-add-big btn-expand-form"><i class="fa fa-plus"></i><span class="hidden-480">{!! trans('admin::messages.add-name',['name'=>trans('admin::controller/room-availability.room-availability')]) !!} </span></a>
        </div>
        @endif
    </div>
    <div class="portlet-body">
        <div class="table-container">
            ...
            <table class="table table-striped table-bordered table-hover" id="room-availability-table">
                <thead>
                    ...
                    @include('admin::room-availability.search')
                </thead>
                <tbody>
