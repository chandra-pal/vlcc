...
<div class="portlet light col-lg-12" id="centerwise-users">
    ...
    <div class="portlet-title" id="download_btn_centerwise_users">
        <div class="actions" style="margin-right: 10px;">
            <a href="{{ route('admin.reports.download') }}" class="btn blue btn-add-big"><i class="fa fa-download"></i><span class="hidden-480">Download Excel </span></a>
        </div>
    </div>
    ...
    <div class="portlet-body">
        <div class="table-container">
            ...
            <table class="table table-striped table-bordered table-hover" id="centerwise-users-table">
                <thead>
                    ...
                    @include('admin::reports.users-search')
                </thead>
                <tbody></tbody>
            </table>
        </div>
