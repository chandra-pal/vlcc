...
class UserCreateRequest extends Request {
    ...
    public function rules() {
        $this->sanitize();
        return [
            'username' => 'required|min:4|max:50|unique:admins',
            'email' => 'max:100|email|unique:admins',
    ...
    public function messages() {
        return [
           ...
           // 'email.required' => trans('admin::messages.required-enter', ['name' => trans('admin::controller/user.email')]),
            ...
            'status.required' => trans('admin::messages.required-enter', ['name' => trans('admin::controller/user.status')]),
            'status.numeric' => trans('admin::messages.error-numeric', ['name' => trans('admin::controller/user.status')]),
