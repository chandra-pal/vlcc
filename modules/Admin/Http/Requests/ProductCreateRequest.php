...
/**
 * The class for handling validation requests from ProductController::store()
 * 
 * 
...
class ProductCreateRequest extends Request {
    ...
    public function messages() {
        return [
            ...
            'product_detail_page_url.min' => trans('admin::messages.error-minlength-number', ['name' => trans('admin::controller/products.product-detail-page-url'), 'number' => '2']),
            'product_detail_page_url.max' => trans('admin::messages.error-maxlength-number', ['name' => trans('admin::controller/products.product-detail-page-url'), 'number' => '255']),
