...
/**
 * The class for handling validation requests from RoomController::store()
 *
 *
...
class RoomCreateRequest extends Request {
    ...
    public function rules() {
        $this->sanitize();
        return [
            'name' => 'required|max:200|regex:/^(?![0-9]*$)[a-zA-Z0-9\s\-()\/ ]+$/|unique:rooms,name,null,id,center_id,' . $this->all()['center_id'],
            'center_id' => 'required',
