...
class DietPlanCreateRequest extends Request {
    ...
    public function rules() {
        ...
        $this->sanitize();
        return [
            'plan_name' => 'required|max:20|regex:/^(?![0-9]*$)[a-zA-Z0-9\s\-()\/ ]+$/',
    ...
    public function messages() {
        return [
            ...
            'calories.integer' => trans('admin::messages.error-integer', ['name' => trans('admin::controller/diet-plan.calories')]), 'calories.min' => trans('admin::messages.error-min', ['name' => trans('admin::controller/diet-plan.calories')]),
