...
class ConfigSettingUpdateRequest extends Request
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'config_constant' => 'required|alphaDash|max:100|unique:config_settings,config_constant,' . $this->config_settings->id,
    ...
    public function authorize()
    {
        ...
        if ($is_edit == 1 || (!empty($own_edit) && ($this->config_settings->created_by == Auth::guard('admin')->user()->id))) {
            return true;
        } else {
            abort(403);
        }
