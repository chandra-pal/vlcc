...
siteObjJs.admin.dietScheduleTypeJs = function () {
...
//            var dd = new Date().addHours(2);
//
//            console.log(dd);
//            $('#end_time').timepicker('setTime', dd);
//        });
//
...
//        }
        ...
        $('body').on('click', '.delete', function (e) {
            e.preventDefault();
            var dietScheduleId = $(this).attr('data-id');
            bootbox.confirm({
            ...
            function handleGroupAction(grid) {
                ...
                var actionUrl = 'diet-schedule-type/' + dietScheduleId;
                jQuery.ajax({
                    url: actionUrl,
                    cache: false,
                    data: {
    ...
    var fetchDataForEdit = function () {
        $('.portlet-body').on('click', '.edit-form-link', function () {
            ...
            var actionUrl = 'diet-schedule-type/' + diet_id + '/edit';
            $.ajax({
                url: actionUrl,
                cache: false,
                dataType: "json",
                ...
                success: function (data)
                {
                    ...
                    siteObjJs.validation.formValidateInit('#edit-diet-schedule-type', handleAjaxRequest);
                    handleTimePicker('edit-diet-schedule-type');
                },
    ...
    var handleTimePicker = function (formId) {
    ...
    return {
        ...
        init: function () {
            ...
            siteObjJs.validation.formValidateInit('#create-diet-schedule-type', handleAjaxRequest);
            handleTimePicker('create-diet-schedule-type');
        }
