siteObjJs.admin.staffJs = function () {
    ...
    var fetchDataForEdit = function () {
        $('.portlet-body').on('click', '.edit-form-link', function () {
            ...
            var actionUrl = 'staff/' + staff_id + '/edit';
            $.ajax({
                url: actionUrl,
                cache: false,
                dataType: "json",
                ...
                success: function (data)
                {
                    ...
                    siteObjJs.validation.formValidateInit('#edit-staff', handleAjaxRequest);
                },
    ...
    var handleTable = function () {
            ...
            dataTable: {
                ...
                "drawCallback": function (settings) {
                    ...
                    api.column(4, {page: 'current'}).data().each(function (group, i) {
                        if (group == 1) {
                            group = '<span class="label label-sm label-success">Male</span>';
                        } else {
                            group = '<span class="label label-sm label-success">Female</span>';
                        }
                        $(rows).eq(i).children('td:nth-child(4)').html(group);
                    });
        ...
        $('#search_config_category').on('change', function () {
    ...
    return {
        ...
        init: function () {
            ...
            siteObjJs.validation.formValidateInit('#create-staff', handleAjaxRequest);
        }
