siteObjJs.admin.machineTypeJs = function () {
    ...
    var fetchDataForEdit = function () {
        $('.portlet-body').on('click', '.edit-form-link', function () {
            ...
            var machine_type_id = $(this).attr("id");
            var actionUrl = 'machine-type/' + machine_type_id + '/edit';
            $.ajax({
                url: actionUrl,
                cache: false,
                dataType: "json",
                ...
                success: function (data) {
                    ...
                    siteObjJs.validation.formValidateInit('#edit-machine-type', handleAjaxRequest);
                },
    ...
    return {
        ...
        init: function () {
            ...
            siteObjJs.validation.formValidateInit('#create-machine-type', handleAjaxRequest);
        }
