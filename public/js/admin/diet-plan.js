...
siteObjJs.admin.dietPlanJs = function () {
...
// Initialize all the page-specific event listeners here.
    ...
    var initializeListener = function () {
        ...
        $('body').on('click', '.delete', function (e) {
            ...
            function handleGroupAction(grid) {
                ...
                var actionUrl = 'diet-plan/' + dietPlanId;
                jQuery.ajax({
                    url: actionUrl,
                    cache: false,
                    data: {
    ...
    var fetchDataForEdit = function () {
        $('.portlet-body').on('click', '.edit-form-link', function () {
            ...
            var actionUrl = 'diet-plan/' + diet_plan_id + '/edit';
            $.ajax({
                url: actionUrl,
                cache: false,
                dataType: "json",
...
//        });
    ...
    return {
        ...
        init: function () {
            ...
            siteObjJs.validation.formValidateInit('#create-diet-plan', handleAjaxRequest);
        }
