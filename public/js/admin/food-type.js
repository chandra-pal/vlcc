siteObjJs.admin.foodTypeJs = function () {
...
// Initialize all the page-specific event listeners here.
    ...
    var fetchDataForEdit = function () {
        $('.portlet-body').on('click', '.edit-form-link', function () {
            var food_type_id = $(this).attr("id");
            var actionUrl = 'food-type/' + food_type_id + '/edit';
            $.ajax({
                url: actionUrl,
                cache: false,
                dataType: "json",
                ...
                success: function (data)
                {
                    ...
                    siteObjJs.validation.formValidateInit('#edit-food-type', handleAjaxRequest);
                },
        ...
        grid.init({
            ...
            dataTable: {
                ...
                "columns": [
                    ...
                    {data: 'food_type_name', name: 'food_type_name'},
    ...
    return {
        ...
        init: function () {
            ...
            siteObjJs.validation.formValidateInit('#create-food-type', handleAjaxRequest);
        }
