siteObjJs.admin.beautyServiceJs = function () {
    ...
    var fetchDataForEdit = function () {
        $('.portlet-body').on('click', '.edit-form-link', function () {
            ...
            var beauty_service_id = $(this).attr("id");
            var actionUrl = 'beauty-service/' + beauty_service_id + '/edit';
            $.ajax({
                url: actionUrl,
                cache: false,
                dataType: "json",
                ...
                success: function (data) {
                    ...
                    siteObjJs.validation.formValidateInit('#edit-beauty-service', handleAjaxRequest);
                },
    ...
    return {
        ...
        init: function () {
            ...
            siteObjJs.validation.formValidateInit('#create-beauty-service', handleAjaxRequest);
        }
